...
// 				<Menu className='min-w-6 min-h-6' />
// 			</CustomButton>
// 			{/* <div className='flex-col justify-center my-4  lg:flex-row lg:justify-start items-center gap-x-2 lg:gap-x-4 '>
// 				<CustomButton variant='ghost' className='activeItem'>
// 					{strings.landing.navbarItems.home}
// 				</CustomButton>
// 				<CustomButton variant='ghost' className='inactiveItem'>
...
// 				</CustomButton>
// 			</div> */}
// 			{/* <CustomButton className='py-3 px-6 whitespace-nowrap text-base lg:flex hidden'>
// 				{strings.landing.startTreatment}
// 				</CustomButton> */}
// 			<NavbarItems className='lg:flex hidden' />
// 			<div
...
// 			<CustomButton
// 				className={cn(
// 					"md:py-3 md:px-6 p-2 px-3 whitespace-nowrap md:text-base text-sm ",
// 					className
// 				)}
// 			>
// 				{strings.landing.startTreatment}
...
// // const Navbar = () => {
// // 	return (
// // 		<nav className='absolute lg:relative justify-between items-center w-full h-32 lg:w-[80vw] lg:max-w-[80vw] lg:bg-[#0000001A] backdrop-blur-md mx-auto lg:rounded-xl flex flex-row lg:justify-between lg:items-center px-10 lg:mt-10'>
// // 			<h1 className='text-[3.83rem] text-white font-cabinetGroteskBold'>
// // 				{strings.landing.logo}
// // 			</h1>
// // 			<div className='flex-col justify-center my-4 flex lg:flex-row lg:justify-start items-center gap-x-2 lg:gap-x-4'>
// // 				<CustomButton variant='ghost' className='activeItem'>
// // 					{strings.landing.navbarItems.home}
// // 				</CustomButton>
// // 				<CustomButton variant='ghost' className='inactiveItem'>
...
// // 				</CustomButton>
// // 			</div>
// // 			<CustomButton className='py-3 px-6 whitespace-nowrap text-base'>
// // 				{strings.landing.startTreatment}
// // 			</CustomButton>
// // 		</nav>
// // 	);
